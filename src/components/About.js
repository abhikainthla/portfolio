...
function About() {
  return (
    <div className="about">
      <div>
        <p>
          Hello World! I'm Abhishek Kainthla, a Front-End Web Developer with a
      ...
      <div className="skills">
        ...
        <p style={{fontSize:"13px"}}>I am starving never to stop learning and improving</p>
        </div>
        <div className="skillCard-container">
                <SkillsCard icon={<FiMonitor />} title={"Web Development"} subtitle={"HTML && CSS && JS && REACT"} />
                <SkillsCard icon={<CiMobile2 />} title={"App Development"} subtitle={"Android && iOS"} />
        </div>
        <div className="skill-icons">
        <div style={{backgroundColor:"#e54f26", padding: "5px", borderRadius: "50%"}}>
          <AiOutlineHtml5 size={50} color="#FFFFFF" />
        </div>
        <div style={{backgroundColor:"#0c73b8", padding: "5px", borderRadius: "50%"}}>
          <FaCss3Alt size={50} color="#FFFFFF" />
        </div>
        <div style={{backgroundColor:"#e7a020", padding: "5px", borderRadius: "50%"}}>
          <RiJavascriptLine size={50} color="#FFFFFF" />
        </div>
        <div style={{backgroundColor:"#28a9e0", padding: "5px",borderRadius: "50%"}}>
